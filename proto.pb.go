...
func (x *ServerToServer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerToServer) ProtoMessage() {}

func (x *ServerToServer) ProtoReflect() protoreflect.Message {
	mi := &file_proto_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerToServer.ProtoReflect.Descriptor instead.
func (*ServerToServer) Descriptor() ([]byte, []int) {
	return file_proto_proto_rawDescGZIP(), []int{3}
}

func (x *ServerToServer) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *ServerToServer) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ServerToServer) GetTime() int64 {
	if x != nil {
		return x.Time
	}
	return 0
...
var file_proto_proto_rawDesc = []byte{
	...
	,
...
var file_proto_proto_goTypes = []any{
	...
	(*ServerToServer)(nil),  // 3: ServerToServer
	(*Empty)(nil),           // 4: Empty
}
var file_proto_proto_depIdxs = []int32{
	0, // 0: Server.bid:input_type -> Amount
	4, // 1: Server.result:input_type -> Empty
	3, // 2: Server.leaderToFollowerUpdate:input_type -> ServerToServer
	1, // 3: Server.bid:output_type -> Acknowladgement
	2, // 4: Server.result:output_type -> Outcome
	4, // 5: Server.leaderToFollowerUpdate:output_type -> Empty
