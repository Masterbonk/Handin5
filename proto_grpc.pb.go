...
type ServerClient interface {
	...
	LeaderToFollowerUpdate(ctx context.Context, in *ServerToServer, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *serverClient) LeaderToFollowerUpdate(ctx context.Context, in *ServerToServer, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type ServerServer interface {
	...
	LeaderToFollowerUpdate(context.Context, *ServerToServer) (*Empty, error)
...
func (UnimplementedServerServer) LeaderToFollowerUpdate(context.Context, *ServerToServer) (*Empty, error) {
...
func _Server_LeaderToFollowerUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).LeaderToFollowerUpdate(ctx, req.(*ServerToServer))
	}
	return interceptor(ctx, in, info, handler)
}
